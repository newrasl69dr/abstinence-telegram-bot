...
# 🔐 Настройка переменных окружения с fallback
TOKEN = os.getenv("BOT_TOKEN") or "7970596881:AAGMETGS2Rvcp5PhGvo57l09ODbbBQR19aU"
USER_ID = int(os.getenv("USER_ID") or "918342062")
